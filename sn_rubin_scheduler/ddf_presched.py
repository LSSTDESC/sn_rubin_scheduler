    ...
    if ddf_name == "COSMOS":
        ...
        if len(early_season) > 0:
            ...
            season_vals[early_season] = np.min(
                [max_n_seq_early, season_seq * boost_early_years])
...
def optimize_ddf_times_deprecated(
    ddf_name,
    ddf_RA,
    ddf_grid,
    sun_limit=-18,
...
def generate_ddf_scheduled_obs_deprecated(
    data_file=None,
    flush_length=2,
    mjd_tol=15,
    expt=30.0,
...
def generate_ddf_scheduled_obs_new(
    data_file=None,
    flush_length=2,
    mjd_tol=15,
    expt=30.0,
